...
#define FLOWY_MULTIMEDIA_PLUGIN(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), flowy_multimedia_plugin_get_type(), \
...
static void flowy_multimedia_plugin_handle_method_call(
    FlowyMultimediaPlugin* self,
...
void flowy_multimedia_plugin_register_with_registrar(FlPluginRegistrar* registrar) {
  FlowyMultimediaPlugin* plugin = FLOWY_MULTIMEDIA_PLUGIN(
      g_object_new(flowy_multimedia_plugin_get_type(), nullptr));
