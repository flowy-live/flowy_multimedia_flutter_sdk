...
G_DECLARE_DERIVABLE_TYPE(VideoOutlet, video_outlet, MY_OPENGL, VIDEO_OUTLET, FlPixelBufferTexture)

G_DEFINE_TYPE_WITH_CODE(VideoOutlet,
                        video_outlet,
                                         ...
                                         GError**              error)
{
    auto video_outlet_private
        = (VideoOutletPrivate*) video_outlet_get_instance_private(MY_OPENGL_VIDEO_OUTLET(texture));
